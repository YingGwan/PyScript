...
options = {
    ...
    'mp_head_node':('host.docker.internal', 'host', 'gateway.docker.internal', '192.168.1.164', 'desktop-iv7sff5', '192.168.80.1', '192.168.201.1'),
    'mp_host_list':(('desktop-iv7sff5', 5),),
    'mp_mode':MPI,
    'mp_mode_requested':MPI,
    'mp_mpi_validate':OFF,
    'mp_mpirun_path':'C:\\Program Files\\Microsoft MPI\\bin\\mpiexec.exe',
    'mp_rsh_command':'dummy %H -l tiany -n %C',
    'multiphysics':OFF,
    'noDmpDirect':[],
    'noMultiHost':["solutiontechnique, {'type': 'QUASI-NEWTON'}", "solutiontechnique, {'type': 'QUASI-NEWTON'}"],
    'noMultiHostElemLoop':[],
    'no_domain_check':1,
    'outputKeywords':ON,
    'parameterized':OFF,
    ...
    'thermal':OFF,
    'tmpdir':'C:\\Users\\tiany\\AppData\\Local\\Temp',
    'tracer':OFF,
